...
void blink_pattern_task(void *pvParameter)
{
    ...
    while (1)
    {
        for (int i = 0; i < blink_count; i++)
        {
            ...
            // LED OFF (short break between blinks)
            gpio_set_level(BLINK_GPIO, 0);
            vTaskDelay(BLINK_PULSE_TICKS);
        }
...
void app_main(void)
{
    ...
    /**
     * commented out example defined funcs
    ...
    */
    ...
    /** create blinking task for testing purposes */
    // xTaskCreate(blink_task, "blink_task", 2048, NULL, 5, NULL);

    xTaskCreate(blink_pattern_task, "blink_task_2", 2048, (void *)2, 5, NULL);
}
